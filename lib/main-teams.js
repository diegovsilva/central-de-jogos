...
//
// O escudo usa a URL pública e documentada da API-Football
// (https://media.api-sports.io/football/teams/{id}.png) — não conta cota
// e não muda, dá pra montar direto a partir do ID.
function escudoUrl(id) {
...
].map((time) => ({ ...time, logo: escudoUrl(time.id) }))
